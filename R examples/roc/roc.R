...
active <- read.table("/home/artur/rnd/git/perceptualqa/roc/sample.active", sep=",", header=FALSE)
# loading inactive compounds, or compounds with label2
inactive <- read.table("/home/artur/rnd/git/perceptualqa/roc/sample.inactive", sep=",", header=FALSE)
